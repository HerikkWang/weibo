...
class WeiBoLogin(object):
    ...
    def get_raw_html(self, url):
        ...
        with open('main_html.txt','w+', encoding='utf-8') as file_out:
...
if __name__ == "__main__":
    ...
    weibo = WeiBoLogin()
    weibo.login("13777015316", "595432157")
    weibo.get_raw_html('https://weibo.com/ttwenda/p/show?id=2310684200015198291713')